...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '*𝑀𝐴𝐷𝐸 𝐵𝑌 ✩♎︎ꪶ𝑀𝑅♘︎ 𝐴𝑅𝐽𝑈𝑁𝑆𝐸𝑅🎌ꫂ⁩⁩♎︎✩🇮🇳*' : process.env.ALL_CAPTION,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    WELCOME: process.env.WELCOME === undefined ? 'pp' : process.env.WELCOME,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://imgur.com/gallery/dTZt4Pw.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    AFNN: process.env.TAG_REPLY === undefined ? '916238440754@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? '91628440754' : process.env.ALL_NUMBER,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'ᴀʀᴊᴜɴЅᴇʀ¹¹' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ARJUNSER BOT' : process.env.BOT_NAME,
    SUPPORT: process.env.ASENA === undefined ? '916238440754-994404251420' : process.env.ASENA,
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://c.tenor.com/G9Bu13ZlhVkAAAPo/dancing-funny-dance.mp4' : process.env.GIF_WEL,
    SLINK: process.env.IG === undefined ? 'https://instagram.com/arjun_mom_z?utm_medium=copy_link' : process.env.IG,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://imgur.com/gallery/dTZt4Pw.jpg' : process.env.ALL_IMG,
    SKDL: process.env.DIALOGUE === undefined ? '❤️‍🔥 ✩♎︎ꪶ𝑀𝑅♘︎ 𝐴𝑅𝐽𝑈𝑁𝑆𝐸𝑅🎌ꫂ⁩⁩♎︎✩🇮🇳 ❤️‍🔥' : process.env.DIALOGUE,
    ...
    YAK: process.env.YAK === undefined ? '916238440754,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUDO: process.env.SUDO === undefined ? '916238440754,0' : process.env.SUDO,
    DEBUG: DEBUG,
