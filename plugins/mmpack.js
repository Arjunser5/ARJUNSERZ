...
const code = "╔════◉  ✩♎︎ꪶ𝑀𝑅♘︎ 𝐴𝑅𝐽𝑈𝑁𝑆𝐸𝑅🎌ꫂ⁩⁩♎︎✩🇮🇳 𝐶𝑂𝑀𝑀𝐴𝑁𝐷𝑆 ◉════╗\n\n            ❖═List═❖\n*🔮.yasai       ❴text❵\n🔮.uddika    ❴text❵\n🔮.aah          ❴text❵\n🔮.sir            ❴text❵\n🔮.my3         ❴text❵\n🔮.fuck         ❴text❵\n🔮.hii             ❴text❵\n🔮.asai          ❴text❵\n🔮.hapoi       ❴text❵\n🔮.quby1    ❴text❵\n🔮.quby2    ❴text❵\n🔮.quby3    ❴text❵\n🔮.quby4    ❴text❵\n🔮.cat1    ❴text❵\n🔮.cat2    ❴text❵\n🔮.cat3    ❴text❵\n🔮.cat4    ❴text❵\n🔮.ikka    ❴text❵\n🔮.ikka1    ❴text❵\n🔮.ikka2    ❴text❵\n🔮.ikka3    ❴text❵\n🔮.ikka4    ❴text❵\n🔮.sins    ❴text❵\n\n╚═══❖══▣══▣══❖═══╝\n\n▷Memes re-moded By: *Arjunser*"
...
if (Config.WORKTYPE == 'public') {
 ...
 Asena.addCommand({pattern: 'mmpack', fromMe: false, desc: Ln,}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'my3 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://docs-jojo.herokuapp.com/api/meme-gen?top=%20&bottom=${encodeURIComponent(match[1])}&img=https://imgur.com/dTZt4Pw.jpeg`, { responseType: 'arraybuffer' })
...
Asena.addCommand({ pattern: 'hii ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: '   Me *Made By ✩♎︎ꪶ𝑀𝑅♘︎ 𝐴𝑅𝐽𝑈𝑁𝑆𝐸𝑅🎌ꫂ⁩⁩♎︎✩🇮🇳' })
